...
class Unit3 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('unit3/quiz_unit3');
    }
    ...
    public function quizdisplay()
    {
        ...
        $this->load->view('navbar_New');
        $this->load->model('quizmodel');
        $this->data['questions'] = $this->quizmodel->getQuestions3();
        $this->load->view('unit3/quiz_unit3display', $this->data);
    }
    ...
    public function resultdisplay()
    {
        ...
        $this->load->view('unit3/quiz_unit3result', $this->data);
    }
