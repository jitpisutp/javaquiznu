...
class Unit4 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('unit4/quiz_unit4');
    }
    ...
    public function quizdisplay()
    {
        ...
        $this->load->view('navbar_New');
        $this->load->model('quizmodel');
        $this->data['questions'] = $this->quizmodel->getQuestions4();
        $this->load->view('unit4/quiz_unit4display', $this->data);
    }
    ...
    public function resultdisplay()
    {
        ...
        $this->load->view('unit4/quiz_unit4result', $this->data);
    }
