...
class Unit5 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('unit5/quiz_unit5');
    }
    ...
    public function quizdisplay()
    {
        ...
        $this->load->view('navbar_New');
        $this->load->model('quizmodel');
        $this->data['questions'] = $this->quizmodel->getQuestions5();
        $this->load->view('unit5/quiz_unit5display', $this->data);
    }
    ...
    public function resultdisplay()
    {
        ...
        $this->load->view('unit5/quiz_unit5result', $this->data);
    }
