                        ...
                        <div class="col-sm-50 col-md-12">
                            ...
                            <div class="card shadow-10-strong" style="border-radius: 1rem;">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo site_url('Administator/addingg5'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <select class="container btn btn-light dropdown-toggle float-md-left " id="select" data-toggle="dropdown" style="background-color:E6E6E6; text-align:left;" name="selectunit" onchange="">
                                            ...
                                            <option value="5">บทที่ 5 อาร์เรย์</option>
