                                ...
                                <div class="card shadow-10-strong" style="border-radius: 1rem;">
                                    <div class="card-body">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <h4>บทที่ 3 การเขียนโปรแกรมแบบทำซ้ำ</h4>
                                                </div>
                                                <div class="col-sm-2">
                                                    <button type="addQuiz" class="btn btn-secondary btn-lg" type="button" style="background-color:212124;" onclick="location.href='<?php echo base_url(); ?>index.php/Administator/dashboardAdd3'">เพิ่มข้อสอบ</button>
                                                ...
                                                <?php foreach ($query as $rs) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center">
                                                            <a class="btn btn-sm btn-info" href="<?php echo site_url('Administator/edit3/') . $rs->quiz_ID; ?>">Edit</a>
