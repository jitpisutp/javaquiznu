                        ...
                        <div class="row d-flex justify-content-center align-items-center ">
                            <div class="col-sm-50 col-md-12">
                                ...
                                <div class="card shadow-10-strong" style="border-radius: 1rem;">
                                    <div class="card-body">
                                        <h1>บทที่ 3 การเขียนโปรแกรมแบบทำซ้ำ</h1>
                                        <hr width="100%" color="black" />
                                        <div class="body">
                                            <h4>ข้อสอบ การเขียนโปรแกรมแบบทำซ้ำ จำนวน 10 ข้อ</h4>
                                        </div>
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-12 text-right">
                                                    ...
                                                    <button type="addQuiz" class="btn btn-secondary btn-lg" type="button" style="background-color:212124;" onclick="location.href='<?php echo base_url(); ?>index.php/Unit3/quizdisplay'">เริ่มทำข้อสอบ</button>
                                                </div>
                                            </div>
                                        </div>
