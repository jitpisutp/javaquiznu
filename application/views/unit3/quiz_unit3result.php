                                        ...
                                        <div class="body">
                                            ...
                                            <div id="container">
                                                ...
                                                for ($x = 0; $x < 10; $x++) { ?>
                                                    ...
                                                    <form name="result" method="post" action="<?php echo base_url(); ?>index.php/Unit3">
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-md-12 text-right">
                                                                ...
                                                                <button class="btn btn-secondary btn-lg" style="background-color:212124;" onclick="location.href='<?php echo base_url(); ?>index.php/Unit3'">ทำข้อสอบใหม่</button>
