                        ...
                        <div class="row d-flex justify-content-center align-items-center ">
                            <div class="col-sm-50 col-md-12">
                                ...
                                <div class="card shadow-10-strong" style="border-radius: 1rem;">
                                    <div class="card-body">
                                    <h1>บทที่ 4 วิธีการสร้างและใช้งานเมธอด</h1>
                                        ...
                                        <div class="body">
                                            ...
                                            <div id="container">
                                                ...
                                                for ($x = 0; $x < 10; $x++) { ?>
                                                    ...
                                                    <form name="result" method="post" action="<?php echo base_url(); ?>index.php/Unit4">
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            <div class="col-md-12 text-right">
                                                                ...
                                                                <button class="btn btn-secondary btn-lg" style="background-color:212124;" onclick="location.href='<?php echo base_url(); ?>index.php/Unit4'">ทำข้อสอบใหม่</button>
