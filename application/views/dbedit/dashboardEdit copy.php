                        ...
                        <div class="col-sm-50 col-md-12">
                            ...
                            <div class="card shadow-10-strong" style="border-radius: 1rem;">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo site_url('Administator/editupdate'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <select class="container btn btn-light dropdown-toggle float-md-left " id="select" data-toggle="dropdown" style="background-color:E6E6E6; text-align:left;" name="selectunit" value="<?php echo $questedit->ca_quiz; ?> ">
                                            ...
                                            <option value="6">บทที่ 6 การเขียนโปรแกรมเชิงวัตถุ</option>
                                        </select>
                                        <br><br><br>
                                        <h5>เพิ่มข้อสอบ</h5>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <button class="btn btn-light btn-lg" type="button" style="background-color:ffffff;" onclick="location.href='<?php echo base_url(); ?>index.php/Administator/dashboardAllu1'">กลับสู่หน้าหลัก</button>
