                        ...
                        <div class="col-sm-50 col-md-12">
                            ...
                            <div class="card shadow-10-strong" style="border-radius: 1rem;">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo site_url('Administator/editupdate5'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 text-right">
                                                ...
                                                <button class="btn btn-light btn-lg" type="button" style="background-color:ffffff;" onclick="location.href='<?php echo base_url(); ?>index.php/Administator/dashboardAllu5'">กลับสู่หน้าหลัก</button>
